...
#set text(font: ("Source Sans 3", "Noto Color Emoji", "DejaVu Sans"), lang: "nb", size: 12pt)
...
#let dokumentHeader = context [
    ...
    #grid(
        ...
        column-gutter: 1em,
        pdf.artifact(image("resources/NAVLogoRed.png", height: 1.5cm)),
        [
...
#let seksjonstabell(columns, ..celler) = block(width: 100%, stroke: black, inset: 1pt, table(
    columns: columns,
    stroke: white,
